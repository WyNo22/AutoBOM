...
const RULES: { pattern: RegExp; name: string; knownSite: string }[] = [
  ...
  { pattern: /ebay\./i, name: "eBay", knownSite: "ebay" },
  { pattern: /leboncoin\./i, name: "Leboncoin", knownSite: "leboncoin" },
  { pattern: /manomano\./i, name: "ManoMano", knownSite: "manomano" },
  { pattern: /leroymerlin\./i, name: "Leroy Merlin", knownSite: "leroymerlin" },
  { pattern: /bricozor\./i, name: "Bricozor", knownSite: "bricozor" },
  { pattern: /bricodepot\./i, name: "Brico Dépôt", knownSite: "bricodepot" },
  { pattern: /castorama\./i, name: "Castorama", knownSite: "castorama" },
  { pattern: /bricovis\./i, name: "Bricovis", knownSite: "bricovis" },
  { pattern: /123roulements\./i, name: "123Roulements", knownSite: "123roulements" },
